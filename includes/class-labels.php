	...
	private static function groups() {
		return [
			...
			'task_event_type' => [
				...
				'intake_started' => 'Intake spustený',
				'intake_fetch_failed' => 'Intake načítanie zlyhalo',
				'intake_duplicate_detected' => 'Intake duplicita zdroja',
				'intake_source_ingested' => 'Intake zdroj uložený',
				'intake_finding_created' => 'Intake nález vytvorený',
				'intake_offer_routed' => 'Intake zaradený do ponuky',
				'intake_photo_evidence_created' => 'Intake foto dôkaz vytvorený',
				'intake_finished' => 'Intake dokončený',
				'search_intake_started' => 'Search intake spustený',
				'search_query_generated' => 'Vyhľadávací dopyt vygenerovaný',
				'search_result_found' => 'Výsledok vyhľadávania nájdený',
				'search_result_duplicate' => 'Výsledok je duplicita',
				'source_sent_to_intake' => 'Zdroj odoslaný do intake',
				'source_ingested' => 'Zdroj ingestovaný',
				'finding_created' => 'Finding vytvorený',
				'offer_created' => 'Ponuka vytvorená',
				'offer_updated' => 'Ponuka aktualizovaná',
				'source_fetch_failed' => 'Načítanie zdroja zlyhalo',
				'search_provider_missing' => 'Provider nie je dostupný',
				'search_provider_error' => 'Provider vrátil chybu',
				'intake_failed' => 'Intake zlyhal',
				'search_intake_finished' => 'Search intake dokončený',
				'error' => 'Chyba',
