...
class Toptour_Ref_Task_Events {
	...
	public static function get_allowed_event_types() {
		return [
			...
			'intake_source_ingested',
			'intake_finding_created',
			'intake_offer_routed',
			'intake_photo_evidence_created',
			'intake_finished',
			'search_intake_started',
			'search_query_generated',
			'search_result_found',
			'search_result_duplicate',
			'source_sent_to_intake',
			'source_ingested',
			'finding_created',
			'offer_created',
			'offer_updated',
